            ...
            <li class="card grab">
                ...
                <div class="card-footer">
                    ...
                    <div class="card-footer-functions">
                        <a id="1" class="link-1" onclick="editTask({id: $(this).attr('id'), from: 'kanban'})"><i class="bi bi-pencil"></i></a>
                        <a id="1" class="link-1" onclick="deleteTask({id: $(this).attr('id'), from: 'kanban'})"><i class="bi bi-trash"></i></a>
                    </div>
                </div>
            </li>
        </ul>
